...
const ProductsList = memo(({ purchase }) => {
  ...
  const { mutate: updateProductReview, isLoading: isProductReviewLoading } =
    useUpdateProductReviewStatus()
  const { mutate: updatePurchaseReview } = useUpdatePurchaseReviewStatus()
    ...
    updatePurchaseReview(
      {
        id: purchase.id,
        data: {
          review_comment: "IT გუნდის განხილვა დასრულებულია",
        },
      },
      {
        onSuccess: () => {
  ...
  }, [purchase.id, updatePurchaseReview])
  ...
  return (
    <div className="mt-4">
      ...
      <CrmDialog
        ...
        title={`პროდუქტის განხილვა: ${editingProduct?.name}`}
      >
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <DialogButton
              actionType="approve"
              onClick={() => handleReview(editingProduct)}
