...
import {
  getUserAgreemnets,
  downloadDeliveryAgreement as downloadAgreementService,
...
const handleDownload = async agreementId => {
  try {
    await downloadDeliveryAgreement(agreementId)
...
export default DeliveryAgreementUser
