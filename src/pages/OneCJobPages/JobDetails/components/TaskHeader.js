        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 dark:!text-gray-300">
            <div className="flex items-center gap-1">
              <User2 size={14} className="text-[#105D8D] dark:!text-blue-400" />
              <span>
            ...
            <div className="flex items-center gap-1">
              <Clock size={14} className="text-[#105D8D] dark:!text-blue-400" />
              <span>შეიქმნა: {formatDate(task.data.created_at)}</span>
            </div>
          </div>
        </div>
      </div>
      <p className="text-gray-700 dark:!text-gray-300 mt-3 sm:mt-4 text-sm sm:text-base">
