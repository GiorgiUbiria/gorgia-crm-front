...
const ProfileMenu = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <DropdownToggle
          className="flex items-center justify-center h-16 px-2 sm:px-4 hover:bg-blue-100 dark:!hover:bg-gray-800 transition-colors duration-200"
        ...
        >
          <img
            ...
            alt="Header Avatar"
          />
          <span className="hidden lg:inline-block ml-2 mr-1 text-gray-700 dark:!text-gray-200">
            {user?.name}
          </span>
          <i className="mdi mdi-chevron-down hidden lg:inline-block text-gray-600 dark:!text-gray-400" />
        </DropdownToggle>
