...
export function CrmTableTest({ columns, data }) {
              ...
              <tr key={headerGroup.id} className="dark:!bg-gray-800">
                {headerGroup.headers.map(header => (
                  <th
                    ...
                    className="px-6 py-4 bg-blue-400 dark:!bg-gray-900 border-b border-gray-200 dark:!border-gray-700"
                  >
                        ...
                        <div
                          {...{
                            className: header.column.getCanSort()
                              ? "flex items-center gap-2 cursor-pointer select-none text-gray-700 dark:!text-gray-300 font-medium hover:text-gray-900 dark:!hover:text-gray-100"
