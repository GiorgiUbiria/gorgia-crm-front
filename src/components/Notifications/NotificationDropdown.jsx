...
const NotificationDropdown = () => {
  ...
  return (
    <div className="relative inline-block">
      <button
        onClick={toggle}
        className="relative p-2 text-gray-600 dark:!text-gray-300 hover:text-gray-700 dark:!hover:text-gray-100 transition-colors duration-200"
      >
        <i className="bx bx-bell text-xl" />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30 text-xs text-blue-600 dark:text-blue-300 font-medium ring-1 ring-blue-200 dark:ring-blue-700/50">
            {unreadCount}
          </span>
        )}
      </button>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[420px] rounded-lg shadow-lg transform opacity-100 scale-100 transition-all duration-200">
